...
module "base-network" {
  ...
  public_subnets_cidrs_per_availability_zone  = ["192.168.0.0/16", "192.168.32.0/16", "192.168.64.0/16", "192.168.96.0/16"]
  private_subnets_cidrs_per_availability_zone = ["192.168.128.0/16", "192.168.160.0/16", "192.168.192.0/16", "192.168.224.0/16"]
}
